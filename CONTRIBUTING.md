...
Mask4K-8   1.20µs ± 1%  1.08µs ± 2%  -9.60%  (p=0.008)
```

This shows your changes made the Mask4K benchmark 9.60% faster, and this improvement is statistically significant.
